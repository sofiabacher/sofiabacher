...
#### 🏨 HotelDesk
Sistema de gestión hotelera desarrollado como proyecto Full Stack orientado a la administración de usuarios, habitaciones, reservas y operaciones internas.

* **Tecnologías:** Node.js, Express, React y MySQL.

#### ⚽ MatchManager
Proyecto personal enfocado en la organización, centralización y análisis de calendarios deportivos para múltiples clubes y categorías.
